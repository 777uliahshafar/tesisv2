...
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi 2 ruang dan aspek(ctpaE)}
	\label{tab:ctpaE}
    \centering
...
\newcommand{\xtpabygen}{
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi aspek dan perbedaan gender(xtpaG)}
	\label{tab:xtpaG}
    \centering
...
\multicolumn{2}{c}{\bfseries\diagbox[innerleftsep=10pt,innerrightsep=3pt,width=7em, height=2.2cm]{Ruang}{Aspek\\Ruang}}&
 ...
 \toprule
\multirow{2}{*}{Ra}&Laki-laki  & 20  & 5    & 25 &  19\\
&Perempuan  & 12 & 0    & 12  & 11  \\

\multirow{2}{*}{Rb}&Laki-laki  & 11  & 2    & 8  &  15\\
&Perempuan  & 4  & 0    & 1  & 5  \\


 \midrule

 \multicolumn{6}{l}{\rule{0pt}{1em} \parbox{.8\textwidth}{Catatan: 1. Total respon adalah 150 \\ \hspace*{3.8em} 2. Laki-laki berjumlah 58 orang ;  Perempuan berjumlah 27 orang}}\\
...
\newcommand{\xtpabyusi}{
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi aspek dan perbedaan usia(xtpaU)}
	\label{tab:xtpaU}
    \centering
\begin{tabular}[t]{p{1em}r P{4.3em}
    P{4.3em}P{4.3em}P{4.8em}}
...
\multicolumn{2}{c}{\bfseries\diagbox[innerleftsep=10pt,innerrightsep=3pt,width=7em, height=2.2cm]{Ruang}{Aspek\\Ruang}}&
 {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Aksesibili-tas}}}} & {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Keamanan}}}} & {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Estetika}}}} & {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Fasilitas}}}} \\
 \toprule
\multirow{3}{*}{Ra}&Remaja  & 15    & 5     & 13  & 14  \\
&Dewasa  & 11  & 0    & 18   & 8  \\
&Manula  & 6  &0    & 6   & 8  \\

\multirow{3}{*}{Rb}&Remaja  & 2  & 0     & 2  & 3  \\
&Dewasa  & 8  & 0    & 4   & 11  \\
&Manula  & 5  & 2    & 3   & 6  \\

 \bottomrule

\multicolumn{6}{l}{\rule{0pt}{1em} \parbox{.8\textwidth}{Catatan: 1. Total respon adalah 150 \\ \hspace*{3.8em} 2. Remaja berjumlah 30 orang ;  Dewasa berjumlah 35 orang; Manula berjumlah  20 orang}}\\
\multicolumn{6}{l}{\rule{0pt}{1em}\scriptsize Sumber: analisis, 2022 }\\
\end{tabular}
\end{table}
}
...
\newcommand{\xtpabysuk}{
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi aspek dan perbedaan suku(xtpaS)}
	\label{tab:xtpaS}
    \centering
\begin{tabular}[t]{p{1em}r P{4.3em}
    P{4.3em}P{4.3em}P{4.8em}}
...
\multicolumn{2}{c}{\bfseries\diagbox[innerleftsep=10pt,innerrightsep=3pt,width=7em, height=2.2cm]{Ruang}{Aspek\\Ruang}}&
 {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Aksesibili-tas}}}} & {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Keamanan}}}} & {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Estetika}}}} & {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Fasilitas}}}} \\
 \toprule
\multirow{2}{*}{Ra}&bugis  & 23    & 5     &26   & 25   \\
&nonbugis  & 9   & 0     & 11    & 5  \\

\multirow{2}{*}{Rb}&bugis  & 10    & 1     &6   & 12   \\
&nonbugis  & 5   & 1     & 3    & 8  \\

 \bottomrule

\multicolumn{6}{l}{\rule{0pt}{1em} \parbox{.8\textwidth}{Catatan: 1. Total respon adalah 150 \\ \hspace*{3.8em} 2. suku bugis berjumlah 60 orang ; nonbugis berjumlah 25 orang }}\\
\multicolumn{6}{l}{\rule{0pt}{1em}\scriptsize Sumber: analisis, 2022 }\\
\end{tabular}
\end{table}
}
...
\newcommand{\xtpabypek}{
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi aspek dan perbedaan pekerjaan(xtpaP)}
	\label{tab:xtpaP}
    \centering
\begin{tabular}[t]{p{1em}r P{4.3em}
    P{4.3em}P{4.3em}P{4.8em}}
...
# Extract cols from file
df_elemen <- data.frame(jmlhphn,bntukphn,lbrjln,permjln,wrnabnga,jniskrs,tngkchy )

# Get the rows having at least 1 response
df_elemenpro <- subset(df_elemen, jmlhphn >= 0 | bntukphn >= 0 | lbrjln >= 0 | permjln >= 0| wrnabnga >= 0| jniskrs >= 0| tngkchy >= 0)


gender <- subset(df$gender, jmlhphn >= 0 | bntukphn >= 0 | lbrjln >= 0 | permjln >= 0| wrnabnga >= 0| jniskrs >= 0| tngkchy >= 0)

df$usia <- cut(df$usia, breaks = c(15, 25, 40, 80), labels = c("18-25", "26-40", "> 41"), right = T)

usia <- subset(df$usia, jmlhphn >= 0 | bntukphn >= 0 | lbrjln >= 0 | permjln >= 0| wrnabnga >= 0| jniskrs >= 0| tngkchy >= 0)

pekerjaan <- subset(df$pekerjaan, jmlhphn >= 0 | bntukphn >= 0 | lbrjln >= 0 | permjln >= 0| wrnabnga >= 0| jniskrs >= 0| tngkchy >= 0)

ruang <- subset(df$ruang, jmlhphn >= 0 | bntukphn >= 0 | lbrjln >= 0 | permjln >= 0| wrnabnga >= 0| jniskrs >= 0| tngkchy >= 0)
...
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi 2 ruang dan elemen(ctpeSE)}
	\label{tab:ctpeSE}
    \centering
\begin{tabular}[t]{rP{5.2em}P{5.2em}P{5.4em} }
\hline
...
\newcommand{\ctpeEach}{
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Cross tabulasi ruang*kelompok elemen(ctpeE)}
	\label{tab:ctpeE}
    \centering
\begin{tabular}[t]{rP{5em}P{5em}P{5.5em} }
\hline
\bfseries\diagbox[innerleftsep=8pt,innerrightsep=3pt,width=10em, height=2.5cm]{Elemen \\ruang}{Kelompok}&{\bfseries\parbox[c][2.5cm]{\textwidth}{Ruang a}} &\textbf{Ruang b} & \textbf{Total}\\
...
\newcommand{\xtpebygen}{
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi elemen dan perbedaan gender(xtpeG)}
	\label{tab:xtpeG}
    \centering
\begin{tabular}[t]{r P{2cm}
    P{2.2cm}P{2cm}P{2.2cm}}
\hline
\multirow{2}{*}{\bfseries\diagbox[innerleftsep=3pt,innerrightsep=3pt,width=10em, height=2.4cm]{Elemen \\ruang}{Kelompok}}&\multicolumn{2}{c}{\textbf{Ruang a}} &\multicolumn{2}{c}{\textbf{Ruang b}}\\
...
Jumlah pohon  &14 &2&2&2\\
Bentuk pohon  &20 &10  & 6  &4\\
Lebar jalan  & 26  & 12  & 10  & 3\\

Permukaan jalan  &20 &11  &4  & 2\\
Warna bunga & 7 & 0  & 1  &0\\

Jenis kursi  & 7 & 1  & 1  & 1\\
Tingkat cahaya  & 21 &15  &13  & 4\\
 \bottomrule

\multicolumn{5}{l}{\rule{0pt}{1em} \parbox{.8\textwidth}{Catatan: 1. Total respon adalah 220 \\ \hspace*{3.8em} 2. Laki-laki berjumlah 58 orang ;  Perempuan berjumlah 27 orang}}\\
\multicolumn{5}{l}{\rule{0pt}{1em}\scriptsize Sumber: analisis, 2022 }\\
\end{tabular}
\end{table}
}
...
\newcommand{\xtpebyusi}{
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi elemen dan perbedaan usia(xtpeU)}
	\label{tab:xtpeU}
    \centering
\begin{tabular}[t]{rP{2em}P{2em}P{2em}P{2em}P{2em}P{2em} }
\hline
\multirow{2}{*}{\bfseries\diagbox[innerleftsep=3pt,innerrightsep=3pt,width=10em, height=2.5cm]{Elemen \\ruang}{Kelompok}}&\multicolumn{3}{c}{\textbf{Ruang a}} &\multicolumn{3}{c}{\textbf{Ruang b}}\\
...
Jumlah pohon  & 6   & 5    & 5  & 0 & 1 & 3   \\
Bentuk pohon  & 10    & 14   & 6  &0 & 3 & 7\\
Lebar jalan  & 18     & 10    & 10    & 4 & 7 & 2 \\

Permukaan jalan  & 12    & 12    & 7    & 2 &4 & 0  \\
Warna bunga & 3  & 2    & 2   & 0 & 1 & 0   \\

Jenis kursi& 3  & 3  & 3    & 0   & 1 & 1 \\
Tingkat cahaya  & 13  & 14   &9   & 5 & 8 & 4 \\

 \bottomrule
\multicolumn{7}{l}{\rule{0pt}{1em} \parbox{.8\textwidth}{Catatan: 1. Total respon adalah 220 \\ \hspace*{3.8em} 2. Remaja berjumlah 30 orang ;  Dewasa berjumlah 35 orang; Manula berjumlah  20 orang}}\\
...
\newcommand{\xtpebysuk}{
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi elemen dan perbedaan suku(xtpeS)}
	\label{tab:xtpeS}
    \centering
\begin{tabular}[t]{r P{2cm}
    P{2.2cm}P{2cm}P{2.2cm}}
...
&{\parbox[c][1.9cm]{\textwidth}{bugis}}  & nonbugis & suku & nonbugis\\

 \toprule

Jumlah pohon  &13 &3&1&3\\
Bentuk pohon  &21 &9  & 5  &5\\
Lebar jalan  & 26  & 12  & 10  & 3\\

Permukaan jalan  &22 &9  &5  & 1\\
Warna bunga & 4 & 3  & 1  &0\\

Jenis kursi  & 6 & 3  & 1  & 1\\
Tingkat cahaya  & 29 &7  &11  & 6\\
 \bottomrule

\multicolumn{5}{l}{\rule{0pt}{1em} \parbox{.8\textwidth}{Catatan: 1. Total respon adalah 220 \\ \hspace*{3.8em} 2. bugis berjumlah 60 orang ;  nonbugis berjumlah 25 orang}}\\
\multicolumn{5}{l}{\rule{0pt}{1em}\scriptsize Sumber: analisis, 2022 }\\
\end{tabular}
\end{table}
}
...
\newcommand{\xtpebypek}{
\begin{table}\setlength\tabcolsep{2pt}
	\caption{Crosstabulasi elemen dan perbedaan pekerjaan(xtpeP)}
	\label{tab:xtpeP}
    \centering
\begin{tabular}[t]{rP{2em}P{2em}P{2em}P{2em}P{2em}P{2em} P{2em}P{2em}P{2em}P{2em}}
\hline
