...
<<mRes, eval=F, echo= F, error= F, message= F, results= "asis", warning= F, cache=F,fig.path="../figures/",fig.width=4, fig.height=4, autodep= T>>=
...
@
<<mResChild, echo= F, error= F, message= F, eval=F, warning= F, cache=F>>=
...
\begin{table}
\caption{\label{tab:ctpaE}Crosstabulasi aksesibilitas}
...
\newcommand{\ctpAksRua}{
\begin{table}
\caption{\label{tab:ctpaR}Crosstabulasi aksesibilitas*ruang}
\centering
\begin{tabular}[t]{ll>{\raggedleft\arraybackslash}p{4.3em}>{\raggedleft\arraybackslash}p{4.3em}>{\raggedleft\arraybackslash}p{4.8em}}
\toprule
& Aksesibilitas  & 0 & 1 & \vphantom{1} Total\\
...
\begin{table}
\caption{\label{tab:ctpeE}Crosstabulasi estetika}
...
\bfseries\diagbox[innerleftsep=10pt,innerrightsep=3pt,width=7em, height=2.2cm]{Ruang}{Aspek\\Ruang}&
 ...
 \toprule
Ruang A  & 32 (38\%) & 5 (38\%)   & 37 (44\%) & 30 (35\%) & 104 (69\%) \\
Ruang B  & 15 (18\%) & 2 (8\%)   & 9 (11\%) & 20 (24\%) & 46 (31\%) \\
Total  & 47 (45\%) & 7 (55\%)  & 46 (54\%) & 50 (59\%) &150 (100\%) \\
...
<<mResThree, eval=F, echo= F, error= F, message= F, results= "asis", warning= F, cache=F,fig.path="../figures/",fig.width=4, fig.height=4, autodep= T>>=
# crosstabulation three var by gender
xtpaG <- xtabs(~gender + df_aspekpro$aksesibilitas + ruang,data=df)
xtpaG <- round(100 * prop.table(xtpaG), 0)

xtpkG <- xtabs(~gender + df_aspekpro$keamanan + ruang,data=df)
xtpkG <- round(100 * prop.table(xtpkG), 0)

xtpeG <- xtabs(~gender + df_aspekpro$estetika + ruang,data=df)
xtpeG <- round(100 * prop.table(xtpeG), 0)

xtpfG <- xtabs(~gender + df_aspekpro$fasilitas + ruang,data=df)
xtpfG <- round(100 * prop.table(xtpfG), 0)
...
\multicolumn{2}{c}{\bfseries\diagbox[innerleftsep=10pt,innerrightsep=3pt,width=7em, height=2cm]{Ruang}{Aspek\\Ruang}}&
 ...
 \toprule
\multirow{2}{*}{Ra}&Laki-laki  & 20(24\%)  & 5(6\%)    & 25(29\%) &  19(22\%)\\
&Perempuan  & 12(14\%) & 0    & 12(14\%)  & 11(13\%)  \\

\multirow{2}{*}{Rb}&Laki-laki  & 11 (13\%)  & 2(2\%)    & 8(9\%)  &  15(18\%)\\
&Perempuan  & 4(5\%)  & 0    & 1(1\%)  & 5(6\%)  \\
...
\multicolumn{2}{c}{\bfseries\diagbox[innerleftsep=10pt,innerrightsep=3pt,width=7em, height=2cm]{Ruang}{Aspek\\Ruang}}&
 {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Aksesibili-tas}}}} & {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Keamanan}}}} & {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Estetika}}}} & {\rotatebox[origin=c]{90}{\parbox[c]{2.2cm}{\textbf{Fasilitas}}}} \\
 \toprule
\multirow{3}{*}{Ra}&Remaja  & 15 (18\%)   & 5(6\%)     & 13(15\%)  & 14(16\%)  \\
&Dewasa  & 11(13\%)  & 0    & 18(21\%)   & 8(9\%)  \\
&Manula  & 6(7\%)  &0    & 6(7\%)   & 8(9\%)  \\

\multirow{3}{*}{Rb}&Remaja  & 2(2\%)   & 0     & 2(2\%)  & 3(4\%)  \\
&Dewasa  & 8(9\%)  & 0    & 4(5\%)   & 11(13\%)  \\
&Manula  & 5(6\%)  & 2(2\%)    & 3(4\%)   & 6(7\%)  \\
