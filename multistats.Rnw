...
\begin{table}
\caption{\label{tab:ctpkE}Crosstabulasi keamanan}
...
\newcommand{\ctpKeaRua}{
\begin{table}
\caption{\label{tab:ctpaR}Crosstabulasi keamanan*ruang}
\centering
\begin{tabular}[t]{ll>{\raggedleft\arraybackslash}p{4.3em}>{\raggedleft\arraybackslash}p{4.3em}>{\raggedleft\arraybackslash}p{4.8em}}
\toprule
...
\newcommand{\ctpEstRua}{
\begin{table}
\caption{\label{tab:ctpeR}Crosstabulasi estetika*ruang}
\centering
\begin{tabular}[t]{ll>{\raggedleft\arraybackslash}p{4.3em}>{\raggedleft\arraybackslash}p{4.3em}>{\raggedleft\arraybackslash}p{4.8em}}
\toprule
& Keamanan  & 0 & 1 & \vphantom{1} Total\\
...
\begin{table}
\caption{\label{tab:ctpfE}Crosstabulasi fasilitas}
...
\newcommand{\ctpFasRua}{
\begin{table}
\caption{\label{tab:ctpfR}Crosstabulasi fasilitas*ruang}
\centering
\begin{tabular}[t]{ll>{\raggedleft\arraybackslash}p{4.3em}>{\raggedleft\arraybackslash}p{4.3em}>{\raggedleft\arraybackslash}p{4.8em}}
\toprule
