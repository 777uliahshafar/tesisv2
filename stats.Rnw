...
print(xtable(ctpsG, align = "lldd", multirow = TRUE, hline = TRUE,
             ...
             caption = "Crosstabulasi ruang berdasarkan gender"),
      booktabs = TRUE, include.rownames = FALSE, caption.placement="top", add.to.row=list(list(4),"\\hline sumber: analisis penulis, 2022\\\\ **p= 1 \\\\"),
