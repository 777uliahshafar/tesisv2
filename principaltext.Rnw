...
\subsection{Keamanan}
\label{sub:keamanan}
Keamanan menjadi faktor penting yang dapat mempengaruhi keadaan emosional seseorang yang dapat mengubah preferensi ruang mereka \citep{lis2011}.
...
Salah satu faktor penting dalam mempengaruhi persepsi seseorang terhadap keamanan adalah keberadaan orang \citep{lis2021}.
