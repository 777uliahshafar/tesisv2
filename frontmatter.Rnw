...
\vspace{2\baselineskip}
{\small Diajukan pada Sidang \title\\ Pada tanggal \DTMtoday}
...
\begin{enumerate}
    ...
    \item Dr. Ir. R. Siti Rukayah, MT, selaku Kaprodi Magister Arsitektur FT Undip yang telah memberikan banyak pembelajaran yang berguna dalam penulisan tesis ini.
